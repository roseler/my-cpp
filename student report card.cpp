...
{
	cout << "\nEnter The SR Number of student ";
	cin >> rollno;
...
void class_result()
{
	...
	cout <<"\n\n\t\t ALL STUDENTS RESULT \n\n";
	cout << "=================================================================\n";
	cout << "SR.No       Name                      P   C   M   E   CS   %age   Grade"<<endl;
	cout << "=================================================================\n";
	while(inFile.read(reinterpret_cast<char *> (&st), sizeof(student)))
	{
		st.show_tabular();
...
void result()
{
	...
	case '2' :	cout<<"\n\n\t Enter SR Number Of Student : "; cin>>rno;
...
void intro()
{
	...
	cout << "\n\n\t\tREPORT CARD";
	cout << "\n\n\t\t  PROJECT";
	cout << "\n\n\n\tMADE BY : Roseler Tanedo | John David Buenaventura | Laurence James Jalos";
...
void entry_menu()
{
	...
	case '3':	cout << "\n\n\t Please Enter The SR number "; cin>>num;
